...
class VideoPlayerWidget extends StatefulWidget {
  String url;
  VideoPlayerWidget({required this.url, super.key});
  ...
  void initState() {
    ...
    _controller.addListener(() {
      if (_controller.value.isPlaying) {
        _authWidgetProvider!.setVideoStatus(VideoStatus.playing);
      } else if (_controller.value.duration == _controller.value.position) {
        _authWidgetProvider!.setVideoStatus(VideoStatus.endVideo);
      } else {
        _authWidgetProvider!.setVideoStatus(VideoStatus.pause);
      }
    });
  }
